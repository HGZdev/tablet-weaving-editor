...
import { findByText, renderWithRouter } from "../helpers";
...
describe("FilePanel Component", () => {
  ...
  describe("Component Rendering", () => {
    test("renders file panel with correct buttons and input", async () => {
      renderWithRouter(
  ...
  describe("File Operations", () => {
    ...
    test("handles file download interaction correctly", async () => {
